...
2. Instala vm-contestant en una VM siguiendo las instrucciones de vm-contestant/README.md (probado con VirtualBox, VMWare, Boxes y UTM) siguiendo las instrucciones de vm-contestant/README.md
...
2. Install vm-contestant in a VM while following instructions from vm-contestant/README.md (tested with VirtualBox, VMWare, Boxes and UTM) while following instructions from vm-contestant/README.md
